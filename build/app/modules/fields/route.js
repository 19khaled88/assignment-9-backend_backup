...
router.delete('/delete/:id', controller_1.FieldController.deleteFieldController);
...
router.get('/allGameType', controller_1.FieldController.getSingleFieldController);
